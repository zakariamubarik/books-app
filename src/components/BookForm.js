...
function BookForm() {
  return (
    ...
    <div className='row'>
     ...
     <input id='book_title' type="text" className='valdate'/>
     <label htmlFor='book_title'>Book Title</label>
     </div>

     <div className='input-field col s6'>
     <input id='book_author' type="text" className='valdate'/>
     <label htmlFor='book_author'>Book Authot</label>
     </div>
    </div>
    ...
    <div className='row'>
     ...
     <div className='input-field col s6'>
     <input id='book_category' type="text" className='valdate'/>
     <label htmlFor='book_category'>Book Category</label>
     </div>

     <div className='input-field col s6'>
     <input id='book_isbn' type="text" className='valdate'/>
